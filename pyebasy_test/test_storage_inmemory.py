...
class TestInMemoryStore(TestCase):
    def test_add_remove_directory(self):
        ...
        # before BAR added
        foo_contents_before_bar_added = store.get_children(some_testing_data.FOO_DIRECTORY.path)
        ...
        # after BAR added
        foo_contents_after_bar_added = store.get_children(some_testing_data.FOO_DIRECTORY.path)
        ...
        # after BAR removed
        foo_contents_after_bar_removed = store.get_children(some_testing_data.FOO_DIRECTORY.path)
    ...
    def test_add_remove_replace_file(self):
        ...
        # before LIPSUM added
        root_contents = store.get_children(some_testing_data.ROOT_DIRECTORY_PATH)
    ...
    def test_get_element_and_children(self):
        ...
        self.assertEqual(some_testing_data.ROOT_DIRECTORY, store.get_element(some_testing_data.ROOT_DIRECTORY_PATH))
        foo_contents = store.get_children(some_testing_data.ROOT_DIRECTORY_PATH)
        ...
        self.assertEqual(some_testing_data.BAR_DIRECTORY, store.get_element(some_testing_data.BAR_DIRECTORY.path))
        bar_contents = store.get_children(some_testing_data.BAR_DIRECTORY.path)
        ...
        self.assertEqual(some_testing_data.AUX_DIRECTORY, store.get_element(some_testing_data.AUX_DIRECTORY.path))
        aux_contents = store.get_children(some_testing_data.AUX_DIRECTORY.path)
        ...
        self.assertEqual(some_testing_data.LOREM_FILE, store.get_element(some_testing_data.LOREM_FILE.path))
        self.assertEqual(some_testing_data.IPSUM_FILE, store.get_element(some_testing_data.IPSUM_FILE.path))
        self.assertEqual(some_testing_data.LIPSUM_FILE, store.get_element(some_testing_data.LIPSUM_FILE.path))
...
class TestInMemoryStorageModifier(TestCase):
    ...
    def test_create_directory(self):
        ...
        owner_contents = self.store.get_children(some_testing_data.FOO_DIRECTORY.path)
    ...
    def test_remove_directory(self):
        ...
        owner_contents = self.store.get_children(some_testing_data.BAR_DIRECTORY.path)
    ...
    def test_remove_file(self):
        ...
        owner_contents = self.store.get_children(some_testing_data.BAZ_DIRECTORY.path)
    ...
    def test_update_file(self):
        ...
        owner_contents = self.store.get_children(some_testing_data.ROOT_DIRECTORY_PATH)
